...
# Country related tags
  ...
  'berlin', 'bavaria', 'bayern', 'bremen', 'berlin hip-hop', 'berlin funk',
  ...
  'deutsche artisten', 'deutscher hiphop', 'deutscher hip hop',
  'deutscher hip-hop', 'deutschrap mit niveau', 'deutsch rap', 'deutsch hiphop',
  'deutsche die man sich antuen kann', 'deutscher sprechgesang',
  ...
  'good german stuff', 'german metal', 'german independent', 'german hiphop',
  'german hip-hop', 'german hip hop', 'german rap', 'guterdehiphop',
  'german reggae', 'german dancehall', 'german rapp', 'germanrap',
  'hamburger schule', 'hamburg', 'hamburg city', 'hamburg hip hop', 'hamburger',
